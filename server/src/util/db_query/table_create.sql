...
ALTER TABLE "Order_Item" ADD FOREIGN KEY ("Product_Index") REFERENCES "Product" ("Index");

ALTER TABLE "Product" ADD FOREIGN KEY ("Category_Id") REFERENCES "Category" ("Category_Id");

ALTER TABLE "Stock" ADD FOREIGN KEY ("Product_Index") REFERENCES "Product" ("Index");

ALTER TABLE "CartItem" ADD FOREIGN KEY ("Product_Index") REFERENCES "Product" ("Index");
