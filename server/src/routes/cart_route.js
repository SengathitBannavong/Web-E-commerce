...
// ==================== CART ROUTES ====================
cart_router.get("/:userId", get_cart);
cart_router.post("/", create_cart);
cart_router.put("/:userId", update_cart);
cart_router.delete("/:id", delete_cart);
cart_router.delete("/clear/:userId", delete_all_cart);

// ==================== CART ITEM ROUTES ====================
cart_router.get("/items/:userId", get_all_details_cart_by_user_id);
...
cart_router.delete("/items/:id", delete_cart_item); // <<< TEST ALL
