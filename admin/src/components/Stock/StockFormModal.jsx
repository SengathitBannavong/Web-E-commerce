      ...
      <div className="relative bg-white rounded-lg shadow-xl w-full max-w-md mx-4 max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          <div>
            ...
            {mode == 'edit' ? (
              <input name="Product_Id" type="text" value={formData.Product_Id} readOnly className="w-full px-3 py-2 border border-slate-300 rounded-lg bg-slate-100 cursor-not-allowed" />
            ) : (
              <input name="Product_Id" type="text" value={formData.Product_Id} onChange={handleChange} className="w-full px-3 py-2 border border-slate-300 rounded-lg" required />
            )}
          </div>
          ...
          {mode === 'edit' && (
            <div>
              ...
              <input type="text" value={stock?.Product_Name || ''} readOnly className="w-full px-3 py-2 border border-slate-300 rounded-lg bg-slate-100 cursor-not-allowed" />
            </div>
          )}
